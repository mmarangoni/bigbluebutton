...
class CallManager {
  static class CallStates {
    ...
    static get transferIntoConference() {
  ...
  function hangupAudio(afterExitCall = () => {}) {
    if (!MEDIA_CONFIG.useSIPAudio) {
      vertoExitAudio();
      return;
    } else {
...
let CallManagerSingleton = new CallManager();
export default CallManagerSingleton;
